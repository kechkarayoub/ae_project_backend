...
class ContactBuy(models.Model):
    ...
    last_name = models.CharField(_("Nom"), blank=False, max_length=30)
    lot_size_min = models.PositiveIntegerField(_("Taille de la propriété min(m²)"), default=0,)
    lot_size_max = models.PositiveIntegerField(_("Taille de la propriété max(m²)"), default=0,)
